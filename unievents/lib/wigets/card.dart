    ...
    return GestureDetector(
        onTap: () {
          Navigator.of(context).push(
              MaterialPageRoute(builder: (context) => const SecondPage(heroTag: 1)));
        },
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          IconButton(
                                                      ...
                                                      Get.back(),
                                                        Get.snackbar('Quit', 'Participation deleted', snackPosition: SnackPosition.BOTTOM, backgroundColor: Colors.redAccent)}
                                                      ),
                                            ],
                                          ),
                                        ],
